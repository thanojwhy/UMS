...
<body>
	<div class="container my-4">
		<div class="container row">
    		<h5 class="modal-title col-11" id="departmentModalLabel">Departments</h5>
	                 ...
	                 <c:forEach items="${departments}" var="d">
                		<tr>
                    		<form action="updateDept" method="post">
                        		...
                        		<td>${d.deptId}</td>
                        		<td><input type="text" name="deptName" value="${d.deptName}"></td>
                        		<td><button type="submit" class="btn btn-primary"><i class="bi bi-pencil-square"></i></button></td>
                        		<td><button type="submit" formaction="deleteDept" class="btn btn-danger"><i class="bi bi-trash3"></i></button></td>
                    		</form>
                		</tr>
            		</c:forEach>
	            </tbody>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form id="insertForm" action="insertDept" method="post">
