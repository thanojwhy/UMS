...
<body>
	<div class="container my-4">
		<div class="container row">
    		<h5 class="modal-title col-11" id="departmentModalLabel">Faculty</h5>
	                 ...
	                 <c:forEach items="${faculty}" var="f">
                		<tr>
                    		<form action="updateFaculty" method="post">
                        		...
                        		<td><input type="text" name="deptId" value="${f.deptId}"></td>
                        		<td><button type="submit" class="btn btn-primary"><i class="bi bi-pencil-square"></i></button></td>
                        		<td><button type="submit" formaction="deleteFaculty" class="btn btn-danger"><i class="bi bi-trash3"></i></button></td>
                    		</form>
                		</tr>
            		</c:forEach>
	            </tbody>
	    ...
	    <div class="modal-dialog">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                ...
	                <form id="insertForm" action="insertFaculty" method="post">
