...
<body class="bg-secondary" data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" id="oc" style="--bs-bg-opacity: 0.9">
        ...
        <div class="offcanvas-body">
            ...
            <a href="${pageContext.request.contextPath}/course/viewCourse" type="button" class="btn btn-dark text-light col-11 p-3 m-3">Courses</a>
            <a href="#" class="btn btn-dark text-light col-11 p-3 m-3">Enrollments</a>
            <a href="${pageContext.request.contextPath}/faculty/viewFaculty" type="button" class="btn btn-dark text-light col-11 p-3 m-3">Faculties</a>
            <a href="${pageContext.request.contextPath}/department/viewDept" type="submit"  class="btn btn-dark text-light col-11 p-3 m-3">Departments</a>
        </div>
    </div>
    <!-- Modal for Signin -->
        ...
        <div id="carouselExampleControls" class="carousel slide col-8 m-3" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src='https://i.imgur.com/wJsns6a.jpeg' class="d-block w-100" alt="University 1">
                </div>
                <div class="carousel-item">
                    <img src='https://i.imgur.com/hUA5TFW.jpeg' class="d-block w-100" alt="University 2">
                </div>
                <div class="carousel-item">
                    <img src='https://i.imgur.com/A3hCpJK.jpeg' class="d-block w-100" alt="University 3">
                </div>
            </div>
